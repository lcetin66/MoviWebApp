"""
MovieWeb-App Main Application File

This module handles routing, API integration, and database setup for the MovieWeb-App.
It uses Flask for the web framework, SQLAlchemy for database operations,
and requests for fetching data from the OMDB API.
"""
import os
import requests
...
def home():
    """
    Returns the home page with a list of all users.
    """
...
def get_user_movies(user_id):
    """
    Returns the movies for a specific user ID.
    """
